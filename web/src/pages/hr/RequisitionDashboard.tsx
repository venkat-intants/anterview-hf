    ...
    <div className="mx-auto w-full max-w-[1100px] px-4 py-8">
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <div className="flex flex-col gap-5">
          ...
          <GlassCard className="p-5">
            <h2 className="mb-2 text-[15px] font-semibold text-foreground">By stage</h2>
            {req.funnel.length === 0 ? (
              <p className="text-[12.5px] text-muted-foreground">Nobody has applied yet.</p>
            ) : (
              <ul className="flex list-none flex-col gap-1.5">
                {req.funnel.map((stage) => (
                  ...
                  >
                    <span className="text-[var(--ui-soft)]">{stage.status}</span>
